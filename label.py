...
def label_gen(h, t, res):
  ...
  (curv2_0, left_top_0, extra_pt) = p.wg_curve(right_top_0, 0, 180, r, t, res)
  ...
  (curv1_3, mid_3, extra_pt) = p.wg_curve(low_3, 270, 180, r+t/4, t, res)
  (curv2_3, top_3, extra_pt) = p.wg_curve(mid_3, 270, 180, r+t/4, t, res)
  ...
  (curv1_5, mid_5, extra_pt) = p.wg_curve(low_5, 270, 180, r+t/4, t, res)
  ...
  (curv2_6, mid_6, extra_pt) = p.wg_curve(left_bottom_6, 180, 360, r, t, res)
  ...
  (curv1_9, end1_9, extra_pt) = p.wg_curve(start_9, 0, 360+angle_9, r, t, res)
