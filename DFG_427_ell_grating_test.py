...
# import DFG_427_constants as cons
import DFG_200_constants as cons
...
path = 'C:/Users/adlogan/Dropbox/Projects/Frequency Conversion/Layout/KLayout/DFG200/Elliptical Gratings/'

arc = [20,25,30]            # arc of elliptical focusing gratings
angle = [10,20,30]          # angle with major axis
eccentricity = [0.1,0.15,0.2,0.3]   # ellipse eccentricity
...
for gr_type in ['SHG_1','SHG_2']:

  if gr_type in wg_type:
    wg_type = gr_type
  else:
    wg_type = 'Multi'
