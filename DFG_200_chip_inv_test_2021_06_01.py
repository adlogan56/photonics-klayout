...
path = 'C:/Users/adlogan/Dropbox/Projects/Frequency Conversion/Layout/KLayout/DFG200/Inverse Design Grating Test 2021 06 01/'
path_test = path + 'Devices/'
path_array = path + 'Arrays/'

filename_full = 'DFG200_SHG_Inv_Test'
...
expand_mod =   range(-30,31,10)#  [-40,0,40] 
...
for tick in range(24): #[-40,-30,-20,-10,0,10,20]:
